        ...
        for {
                ...
                case chTasks <- totalRequests:
                        ...
                        if totalRequests % 1000 == 0 {
                                ...
                                t.Logf("**** Total Requests: %v, duration: %v, QPS: %v", totalRequests, duration, float64(totalRequests)/duration.Seconds())
                        }
                }
        }
}
...
go test ./kv/test_raftstore/ -run ReadWrite -v -count=1
# > bench.log
